package com.asterisk.opensource.encrypt;

import com.asterisk.opensource.exception.Exceptions;
...
public class Digests {
    ...
    public static String md5(String input) {
        return bytesToString(digest(input.getBytes(Charsets.UTF_8), MD5, null, 0));
    }
